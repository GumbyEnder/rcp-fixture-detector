...
## 1. OCR reporting and metrics pass
Status: pending
...
## Working order
1. Finish the limited cloud UI plan.
2. Do the OCR reporting and metrics pass.
3. Add sheet classification.
4. Reduce runtime and tighten caching.
5. Add confidence and reconciliation checks.
6. Improve fan handling.
